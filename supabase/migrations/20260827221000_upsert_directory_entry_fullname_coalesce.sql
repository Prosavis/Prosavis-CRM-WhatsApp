-- Inbox Comercial 311: new phones failed because crm_directory.full_name is NOT NULL
-- and commercial sync_conversation_to_directory omits full_name on INSERT.
-- Only the INSERT full_name value changes (COALESCE). Body matches production.
