export const WHATSAPP_CLOUD_PRODUCTION = {
  ...
  phoneDisplay:
    import.meta.env.VITE_WHATSAPP_PHONE_DISPLAY?.trim() || '+57 312 253 1271',
  botLabel: import.meta.env.VITE_WHATSAPP_BOT_LABEL?.trim() ?? '',
};

export const WHATSAPP_CLOUD_COMMERCIAL = {
  phoneNumberId:
    import.meta.env.VITE_WHATSAPP_COMMERCIAL_PHONE_NUMBER_ID?.trim() ||
    '1043086062223440',
  wabaId:
    import.meta.env.VITE_WHATSAPP_COMMERCIAL_WABA_ID?.trim() ||
    '1680332820009096',
  phoneDisplay:
    import.meta.env.VITE_WHATSAPP_COMMERCIAL_PHONE_DISPLAY?.trim() ||
    '+57 311 212 1108',
  label:
    import.meta.env.VITE_WHATSAPP_COMMERCIAL_LABEL?.trim() || 'Inbox Comercial',
};
