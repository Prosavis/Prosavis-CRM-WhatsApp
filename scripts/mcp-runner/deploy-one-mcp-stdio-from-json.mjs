/**
 * Despliega una función leyendo _mcp-call JSON vía MCP stdio (mismo payload que CallMcpTool).
 * Uso: node deploy-one-mcp-stdio-from-json.mjs <json-path> [SUPABASE_ACCESS_TOKEN]
 * Sin token: imprime instrucción CallMcpTool y sale 0.
 */
import fs from 'fs';
...
const client = new Client({ name: 'deploy-one-mcp-stdio', version: '1.0.0' }, { capabilities: {} });
