/**
 * Lee args JSON y despliega vía createSupabaseApiPlatform (mismo backend que deploy_edge_function MCP).
 * Uso: node deploy-args-via-platform.mjs <args.json> [sbp_token]
 */
import fs from 'fs';
