/**
 * Despliega wave A leyendo _callmcp-args-{name}.json desde disco.
 * Con token: MCP HTTP o Management API. Sin token: exit 2 + needCallMcpTool.
 */
import fs from 'fs';
...
async function deployOne(args, transport) {
  const client = new Client({ name: 'deploy-wave-a-disk', version: '1.0.0' }, { capabilities: {} });
