/**
 * Despliega deploy_edge_function leyendo mcp-args-*.json (payload completo).
 * Uso: node deploy-mcp-args-via-http.mjs <mcp-args.json> [token]
 */
import fs from 'fs';
...
const client = new Client({ name: 'deploy-mcp-args-http', version: '1.0.0' }, { capabilities: {} });
