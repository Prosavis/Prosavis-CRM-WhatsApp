/**
 * Despliega Edge Function leyendo payload JSON (MCP deploy_edge_function vía HTTP).
 * Uso: node deploy-edge-from-payload-json.mjs <payload.json> [token]
 */
import fs from 'fs';
...
const client = new Client({ name: 'deploy-edge-from-payload', version: '1.0.0' }, { capabilities: {} });
