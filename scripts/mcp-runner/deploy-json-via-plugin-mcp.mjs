/**
 * Despliega un payload JSON usando MCP HTTP (requiere SUPABASE_ACCESS_TOKEN)
 * o imprime instrucción para CallMcpTool.
 * Uso: node deploy-json-via-plugin-mcp.mjs <payload.json>
 */
import fs from 'fs';
...
const client = new Client({ name: 'deploy-json-via-plugin', version: '1.0.0' }, { capabilities: {} });
