/**
 * Lee _mcp-call-{name}.json y despliega vía Supabase Management API (multipart).
 * Requiere SUPABASE_ACCESS_TOKEN (o sesión `supabase login`).
 * Uso: node scripts/deploy-mcp-from-json.mjs <function-name>
 */
import fs from 'fs';
...
if (!name) {
  console.error('Uso: node deploy-mcp-from-json.mjs <function-name>');
  process.exit(1);
}
